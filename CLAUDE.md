...
| desde | decisión |
|---|---|
| 5-sep-2026 | **Ale en la quietud del inicio, 10 % de las veces** (Niaz 2 se queda con el 90 %). Misma estructura que Niaz 2 y **la misma espera de 8 s** — los 2 s de la primera vez se retiraron el 4-sep porque secuestraban la pantalla al arrancar. Su pantalla lleva a dos botones: **"Buscar rutas con mi perro"** (paseos) y **"Problema de comportamiento"**, que va a la anamnesis; en italiano esa misma pantalla ya ofrece elegir ABA o Cognitivista. Textos en español, inglés e italiano. |
