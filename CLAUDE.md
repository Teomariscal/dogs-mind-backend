...
| 5-sep-2026 | **Quietud: 4 s el PRIMER uso, 8 s a partir de entonces.** Los 4 se pueden bajar sin que salte al arrancar porque la GRACIA de arranque es otra guarda distinta, que también baja a 4 para que esos 4 s se cumplan. Corrige la línea del 4-sep que decía "siempre 8". |
