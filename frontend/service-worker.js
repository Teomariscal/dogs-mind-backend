// Dogs Mind Service Worker — v95 (rediseno vibrant extendido a s-tokens: gradient verde-deep + halos + grid; donut + saldo + packs + seccion cuenta con textos cream + cards con borde cyan)
//
// ESTRATEGIA:
...
const CACHE_NAME = 'dogs-mind-v95';
